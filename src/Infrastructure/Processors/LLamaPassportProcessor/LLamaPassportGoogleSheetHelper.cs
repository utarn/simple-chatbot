...
{
    public class LLamaPassportGoogleSheetHelper
    {
        ...
        public LLamaPassportGoogleSheetHelper(ILogger<LLamaPassportProcessor> logger)
        {
            _logger = logger;
            ...
            try
            {
                ...
                _sheetsService = new SheetsService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "ChatbotPassportOCR",
                });
